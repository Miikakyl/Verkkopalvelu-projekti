  ...
  return (
   <>
    ...
    <Routes>
      ...
      <Route path="AdminPanel" element={<AdminPanel  footerHidingState={setFooterHidden} />}></Route>
      ...
      <Route path="WalkshoesMen/nikeairforce720" element={<NikeAirforce720 callback={sendShoppingItem} walk={[WalkShoesM]} productHeader="Miesten kävelykengät" name="Nike Airforce 720" price={120} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: italia"]} color={["Musta"]} shoeSize={[40,41,42,44]}/>}></Route>
      <Route path="WalkshoesWomen/nikeairforce720" element={<NikeAirforce720 callback={sendShoppingItem} walk={[WalkShoesW]} productHeader="Naisten kävelykengät" name="Nike Airforce 720" price={120} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: italia"]} color={["Musta", "Violetti"]} shoeSize={[38,39,40,41]}/>}></Route>
      <Route path="WalkshoesMen/adidasy3" element={<AdidasY3 walk={[WalkShoesM]} callback={sendShoppingItem} productHeader="Miesten kävelykengät" name="Adidas Y3" price={100} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: intia"]} color={["Musta"]} shoeSize={[40,41,42,44]}/>}></Route>
      <Route path="WalkshoesWomen/adidasy3" element={<AdidasY3 walk={[WalkShoesW]} callback={sendShoppingItem} productHeader="Naisten kävelykengät" name="Adidas Y3" price={100} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: intia"]} color={["Musta"]} shoeSize={[38,39,40,41]}/>}></Route>
      ...
      <Route path="WalkshoesMen/yeezy" element={<Yeezy walk={[WalkShoesM]} callback={sendShoppingItem} productHeader="Miesten kävelykengät" name="Yeezy" price={200} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% puuvilla", "Ulkopohja: 100% kumia", "Valimistettu: portugali"]} color={["Ruskea"]} shoeSize={[40,41,42,44]}/>}></Route>
      <Route path="WalkshoesWomen/yeezy" element={<Yeezy walk={[WalkShoesW]} callback={sendShoppingItem} productHeader="Naisten kävelykengät" name="Yeezy" price={200} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% puuvilla", "Ulkopohja: 100% kumia", "Valimistettu: portugali"]} color={["Ruskea"]} shoeSize={[38,39,40,41]}/>}></Route>
      <Route path="WalkshoesMen/adidasgazelle" element={<Adidasgazelle callback={sendShoppingItem} walk={[WalkShoesM]} productHeader="Miesten kävelykengät" name="Adidas Gazelle" price={200} information={["Istuvuus: normaali", "Ylä: 100% mokkanahka", "Ylävuori: 100% nahka", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: kiina"]} color={["Sininen"]} shoeSize={[40,41,42,44]}/>}></Route>
      <Route path="WalkshoesWomen/adidasgazelle" element={<Adidasgazelle callback={sendShoppingItem} walk={[WalkShoesW]} productHeader="Naisten kävelykengät" name="Adidas Gazelle" price={200} information={["Istuvuus: normaali", "Ylä: 100% mokkanahka", "Ylävuori: 100% nahka", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: kiina"]} color={["Sininen"]} shoeSize={[38,39,40,41]}/>}></Route>
      ...
      <Route path="SkateboardMen/vansspliton" element={<Vansspliton callback={sendShoppingItem} skate={[SkateBoardM]} productHeader="Miesten skeittikengät" name="Vans Slip On" price={40} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: kiina"]} color={["Musta"]} shoeSize={[40,41,42,44]}/>}></Route>
      ...
      <Route path="SkateboardWomen/vanssplitonpro" element={<Vanssplitonpro callback={sendShoppingItem} skate={[SkateBoardW]} productHeader="Naisten skeittikengät" name="Vans Slip On Pro" price={50} information={["Istuvuus: normaali", "Ylä: 100% mokkanahka", "Ylävuori: 100% nahka", "Pohjallinen: 100% nahka", "Ulkopohja: 100% kumia", "Valimistettu: portugali"]} color={["Vihreä"]} shoeSize={[38,39,40,41]}/>}></Route>
      <Route path="SkateboardMen/vansauthentic" element={<VansAuthentic callback={sendShoppingItem} skate={[SkateBoardM]} productHeader="Miesten skeittikengät" name="Vans Authentic" price={50} information={["Istuvuus: normaali", "Ylä: 100% puuvilla", "Ylävuori: 100% puuvilla", "Pohjallinen: 100% puuvilla", "Ulkopohja: 100% kumia", "Valimistettu: portugali"]} color={["Punainen"]} shoeSize={[40,41,42,44]}/>}></Route>
      ...
      <Route path="SkateboardMen/nikeblazer" element={<NikeBlazer callback={sendShoppingItem} skate={[SkateBoardM]} productHeader="Miesten skeittikengät" name="Nike Blazer" price={60} information={["Istuvuus: normaali", "Ylä: 100% nahka", "Ylävuori: 100% nahka", "Pohjallinen: 100% puuvilla", "Ulkopohja: 100% kumia", "Valimistettu: italia"]} color={["Harmaa"]} shoeSize={[40,41,42,44]}/>}></Route>
      <Route path="SkateboardWomen/nikeblazer" element={<NikeBlazer callback={sendShoppingItem} skate={[SkateBoardW]} productHeader="Naisten skeittikengät" name="Nike Blazer" price={60} information={["Istuvuus: normaali", "Ylä: 100% nahka", "Ylävuori: 100% nahka", "Pohjallinen: 100% puuvilla", "Ulkopohja: 100% kumia", "Valimistettu: italia"]} color={["Harmaa"]} shoeSize={[38,39,40,41]}/>}></Route>
